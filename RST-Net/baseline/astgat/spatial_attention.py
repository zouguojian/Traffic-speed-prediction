...
class Transformer():
    ...
    def encoder(self, inputs=None, input_length=1):
        '''
        ...
        with tf.variable_scope("encoder"):
            # embedding
            self.en_emb = tf.layers.dense(inputs, units=self.hidden_units, name='emb',use_bias=False)
            self.en_emb = tf.reshape(self.en_emb, shape=[self.batch * input_length, self.site_num, self.hidden_units])
