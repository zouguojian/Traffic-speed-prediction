...
def convert_a_to_b(file_a=None, file_b=None, site=208, keys=None):
    ...
    return
'''
convert_a_to_b(file_a='/Users/guojianzou/Traffic-speed-prediction/3S-TBLN/data/metr-la/metr-la.csv',
               file_b='/Users/guojianzou/Traffic-speed-prediction/3S-TBLN/data/metr-la/train_5s.csv',
               site=208,
               keys=keys)
print('finish')
'''
...
adjacent(file_a='/Users/guojianzou/Traffic-speed-prediction/3S-TAEN/data/metr-la/adj_mx.pkl',
         file_b='/Users/guojianzou/Traffic-speed-prediction/3S-TAEN/data/metr-la/adjacent.csv')
print('finish')
...
time = datetime.strptime('2012-03-01', '%Y-%m-%d %H:%M:%S')
print(time.weekday())
