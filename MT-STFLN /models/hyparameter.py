...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--save_path', type=str, default='weights/mt_stfln/', help='save path')
        self.parser.add_argument('--model_name', type=str, default='mt_stfln', help='training or testing model name')
