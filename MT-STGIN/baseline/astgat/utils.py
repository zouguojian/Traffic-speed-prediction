...
def construct_feed_dict(features, w_1, w_2, d_1, d_2, labels, placeholders):
    """Construct feed dictionary."""
    feed_dict = dict()
    feed_dict.update({placeholders['w_1']: w_1})
    feed_dict.update({placeholders['w_2']: w_2})
    feed_dict.update({placeholders['d_1']: d_1})
    feed_dict.update({placeholders['d_2']: d_2})
